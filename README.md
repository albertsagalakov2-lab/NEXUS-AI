...
## Финальный responsive landing

Публичная страница `/` содержит отдельные desktop и mobile layouts, адаптивный hero, генератор-превью, преимущества, примеры, тарифы, FAQ и CTA. Интерфейс чата остаётся доступен по `/chat`.
